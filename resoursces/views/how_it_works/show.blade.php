@extends('layout.main')
@section('page_title', trans('labels.edit_how_it_works'))
@section('content')
            ...
            <div class="row">
                <div class="col-md-12">
                    <h5 class="card-title color-changer fs-4 fw-600" id="horz-layout-colored-controls">
                        {{ trans('labels.edit_how_it_works') }}
                    </h5>
                    <div class="card my-3">
                        <div class="card-body">
                            <form class="form form-horizontal" id="add_how_it_works_form"
                                action="{{ URL::to('/how-it-works/edit/' . $howitworkdata->id) }}" method="POST"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="add_provider_name"
                                                    ...
                                                    name="how_it_works_title" value="{{ $howitworkdata->how_it_works_title }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="form-label" for="address">{{ trans('labels.description') }}
                                                    <span class="text-danger">*</span></label>
                                                <textarea id="add_provider_address" rows="1"
                                                    class="form-control col-md-12 @error('how_it_works_description') is-invalid @enderror"
                                                    name="how_it_works_description" placeholder="{{ trans('labels.enter_description') }}" required>{{ $howitworkdata->how_it_works_description }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="mt-2">
                                                    <img src="{{ helper::image_path($howitworkdata->how_it_works_image) }}"
