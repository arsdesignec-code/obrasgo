...
@section('content')
    @php
        ...
        $user = App\Models\User::where('id', $provider_id)->first();
    @endphp
        ...
        <div class="col-12">
            ...
            <div class="card border-0 box-shadow">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ URL::to('calendar/save') }}" method="POST">
...
@section('scripts')
    <script>
        var sloturl = "{{ URL::to('/calendar/timeslot') }}";
        var select = "{{ trans('labels.select') }}";
        var customerurl = "{{ URL::to('/calendar/getcustomer') }}";
