...
<head>
    ...
    <link rel="stylesheet"
        href="{{ url(env('ASSETSPATHURL') . 'front-assets/plugins//bootstrap/css/bootstrap.min.css') }}">
    <!-- Bootstrap CSS -->
    <link rel="stylesheet"
        href="{{ url(env('ASSETSPATHURL') . 'front-assets/css/font-awesome/font-awesome.min.css') }}">
    <!-- FontAwesome CSS -->
    <link rel="stylesheet" href="{{ url(env('ASSETSPATHURL') . 'front-assets/css/style.css') }}">
    <!-- Custom CSS -->
...
<body>
    <div class="container">
        <div class="row align-items-md-center justify-content-md-center vh-md-100">
            <div class="col-md-6 error-sec-order">
                <div class="d-flex align-items-center justify-content-center">
                    <div class="text-center">
                        ...
                        <p class="text-uppercase fw-bold">An Error Occurred</p>
                        <p>Something is broken. Please let us know what you were doing when this error occurred. We will
                            fix it as
                            soon as possible.</p>
            ...
            <div class="col-md-6">
                <img src="{{ url(env('ASSETSPATHURL') . 'images/404.svg') }}" class="w-100" alt="">
            </div>
        </div>
    </div>
</body>
