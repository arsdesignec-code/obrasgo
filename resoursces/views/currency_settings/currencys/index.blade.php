@extends('layout.main')
@section('page_title', trans('labels.currencys'))
@section('content')
    <section id="contenxtual">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-title fs-4 color-changer fw-600">{{ trans('labels.currencys') }}</h5>
                <div class="d-flex align-items-center" style="gap: 10px;">
                    ...
                    @endif
                    <a href="{{ URL::to('admin/currencys/add') }}"
            ...
            <div class="row ">
                <div class="col-12">
                    ...
                    <div class="alert rgb-secondary-light color-changer border-0 mt-2" role="alert">
                                            ...
                                            <tr class="fs-7 row1 align-middle" id="dataid{{ $currency->id }}"
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        @if ($currency->is_available == 1)
                                                            <a class="btn btn-outline-success btn-sm"
                                                                onclick="statusupdate('{{ URL::to('admin/currencys/currencystatus-' . $currency->code . '/2') }}')">
                                                                <i class="ft-check"></i>
                                                            </a>
                                                        @else
                                                            <a class="btn btn-outline-danger btn-sm"
                                                                onclick="statusupdate('{{ URL::to('admin/currencys/currencystatus-' . $currency->code . '/1') }}')">
                                                                <i class="ft-x"></i>
                                                            </a>
                                                        @endif
                                                    @endif
                                                    ...
                                                    @if (Strtoupper($currency->currency) != 'USD')
                                                        <div class="d-flex flex-wrap gap-2">
                                                            ...
                                                            <a class="btn btn-sm btn-info square hov"
                                                                ...
                                                                href="{{ URL::to('admin/currencys/currency_edit-' . $currency->id) }}"><i
                                                                    class="fa-solid fa-pen-to-square"></i></a>
                                                            <a class="btn btn-sm btn-danger square hov"
                                                                tooltip="{{ trans('labels.delete') }}"
                                                                @if (env('Environment') == 'sendbox') onclick="myFunction()" @else onclick="statusupdate('{{ URL::to('admin/currencys/delete-' . $currency->id . '/1') }}')" @endif><i
