@extends('layout.main')
@section('page_title', trans('labels.add_blog'))
@section('content')
    <section id="basic-form-layouts">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <h5 class="card-title fs-4 color-changer fw-600" id="horz-layout-colored-controls">{{ trans('labels.add_blog') }}</h5>
                    <div class="card my-3">
                        <div class="card-body">
                            <form class="form form-horizontal" id="add_how_it_works_form" action="{{ URL::to('blog/store') }}"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="add_provider_name"
                                                    ...
                                                    value="{{ old('title') }}" placeholder="{{ trans('labels.enter_title') }}"
                                                    required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea id="ckeditor" rows="2" class="form-control col-md-12 @error('description') is-invalid @enderror"
                                                    name="description" placeholder="{{ trans('labels.enter_description') }}" required>{{ old('description') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-actions text-{{ session()->get('direction') == 2 ? 'start' : 'end' }}">
                                        <a class="btn btn-danger px-sm-4"
                                            href="{{ URL::to('blog') }}">{{ trans('labels.cancel') }}
                                        </a>
