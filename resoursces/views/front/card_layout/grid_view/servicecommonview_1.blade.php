<div class="card grid-view-1 rounded h-100">
    <div class="service-img position-relative">
        <a href="{{ URL::to('/home/service-details/' . $sdata->slug) }}">
            <img src="{{ helper::image_path($sdata->service_image) }}" alt="service img" class="serv-img rounded-top">
        </a>
    ...
    <div class="card-body border-bottom">
        <div class="d-flex mb-2 justify-content-between align-items-center gap-2">
            <div class="fs-13 fw-500 text-capitalize">
            ...
            @if (@helper::checkaddons('product_review'))
                @if (@helper::appdata()->review_approved_status == 1)
                    <p class="d-flex align-items-center fs-8 m-0 fw-600">
                        <i class="fa-solid fa-star text-warning"></i>
                        <span class="px-1 color-changer">{{ helper::getaverageratting($sdata->id) }}</span>
                    </p>
                @endif
            @endif
        </div>
        <!-- service title -->
        <h6 class="fs-15 fw-semibold truncate-2 mb-2 text-capitalize">
            <a href="{{ URL::to('/home/service-details/' . $sdata->slug) }}"
        ...
        <div class="d-flex flex-wrap justify-content-between">
            ...
            @if ($sdata->price_type == 'Fixed')
                <span class="time color-changer fs-13 fw-600 d-flex gap-1">
    ...
    <div class="card-footer">
        <div class="d-flex justify-content-between align-items-center">
            <div class="provider-view d-flex align-items-center gap-2 m-0 p-0">
                <img src="{{ helper::image_path($sdata->provider_image) }}" alt="" class="provider-imgs">
                <p class="m-0 fs-15 fw-600 color-changer truncate-1">{{ $sdata->provider_name }}</p>
            </div>
