<div class="card service-card h-100">
    ...
    <div class="service-img">
        ...
        <div class="cat_name text-bg-primary px-2 rounded">
            <span class="fs-8 fw-500 text-capitalize">{{ $sdata->category_name }}</span>
        </div>
    ...
    <div class="card-body">
        ...
        <div class="d-flex flex-wrap justify-content-between mb-2">
            ...
            @if ($sdata->price_type == 'Fixed')
                <span class="time fs-13 fw-600 color-changer d-flex gap-1">
    ...
    <div class="card-footer">
        <div class="provider-view">
            ...
            <p class="m-0 provider-title color-changer">{{ $sdata->provider_name }}</p>
        </div>
