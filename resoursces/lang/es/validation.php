...
return [
    ...
    */
    ...
    'image' => 'Por favor, suba un archivo de imagen válido.',
    ...
    | hace que sea rápido especificar una línea de idioma específica para una
    ...
    */
    ...
    | marcador de posición de atributo por algo más fácil de leer, como
    | "Dirección de Correo Electrónico" en lugar de "email". Esto simplemente
    | nos ayuda a que nuestro mensaje sea más expresivo.
    |
    */
