...
return [
    ...
    "image_dimension" => "The app logo has invalid image dimensions.",
    ...
    "enter_provider_type" => "Please enter provider type name",
    ...
    "enter_whatsapp_contact" => "Please enter whatsapp contact",
    ...
    "enter_provider_id" => "Please enter provider ID",
    ...
    "enter_sub_title" => "Please enter sub title",
    ...
    "enter_ios_url" => "Please enter ios app url",
    "enter_android_url" => "Please enter android app url",
    "enter_icon" => "Icon is required.",
    "enter_payment_name" => " Please enter payment name.",
    ...
    "select_tax_type" => "Please select type of tax",
    "select_banner_section" => "Please select section of banner",
    ...
    "select_payment_option" => "Please select payment option",
    ...
    "provider_type_added" => "Provider type added successfully",
    ...
    "testimonials_added" => "Testimonials added successfully",
    ...
    "assign_handyman" => "Handyman Assigned",
    "complete_booking_msg" => "Booking Completed Successfully!",
    ...
    "accepted_by_provider" => "Booking has been already accepted by Provider.",
    "cancelled_by_provider" => "Booking has been already cancelled by Provider.",
    ...
    "how_it_works_update" => "How It Work updated successfuly",
    "faq_update" => "FAQ updated successfully.",
    "blog_update" => "Blog updated successfully.",
    "service_rating_destroy" => "Rating deleted successfully.",
    ...
    "review_already_exits" => "You have already given review in this service!",
    "okay" => "Okay",
    "service_closed" => "Service is closed. Try after some time.",
    /*--------------------------------------*/
